<?php
/**
 * ComSapGatewaySrvdA2xApiPurchaseorder2V0001POInvoicingPlanItemTypeUpdate
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * ComSapGatewaySrvdA2xApiPurchaseorder2V0001POInvoicingPlanItemTypeUpdate Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\SAP\PurchaseOrder
 * @author   OpenAPI Generator team
 ...
 */
class ComSapGatewaySrvdA2xApiPurchaseorder2V0001POInvoicingPlanItemTypeUpdate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'com.sap.gateway.srvd_a2x.api_purchaseorder_2.v0001.POInvoicingPlanItem_Type-update';
    ...
    */
    ...
    public function setTransactionCurrency($transaction_currency)
    {
        ...
        if ((mb_strlen($transaction_currency) > 3)) {
            throw new \InvalidArgumentException('invalid length for $transaction_currency when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001POInvoicingPlanItemTypeUpdate., must be smaller than or equal to 3.');
        }
    ...
    public function setPurchasingOrganization($purchasing_organization)
    {
        ...
        if ((mb_strlen($purchasing_organization) > 4)) {
            throw new \InvalidArgumentException('invalid length for $purchasing_organization when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001POInvoicingPlanItemTypeUpdate., must be smaller than or equal to 4.');
        }
    ...
    public function setPurchasingGroup($purchasing_group)
    {
        ...
        if ((mb_strlen($purchasing_group) > 3)) {
            throw new \InvalidArgumentException('invalid length for $purchasing_group when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001POInvoicingPlanItemTypeUpdate., must be smaller than or equal to 3.');
        }
    ...
    public function setPurchaseOrderType($purchase_order_type)
    {
        ...
        if ((mb_strlen($purchase_order_type) > 4)) {
            throw new \InvalidArgumentException('invalid length for $purchase_order_type when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001POInvoicingPlanItemTypeUpdate., must be smaller than or equal to 4.');
        }
    ...
    public function setPlant($plant)
    {
        ...
        if ((mb_strlen($plant) > 4)) {
            throw new \InvalidArgumentException('invalid length for $plant when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001POInvoicingPlanItemTypeUpdate., must be smaller than or equal to 4.');
        }
