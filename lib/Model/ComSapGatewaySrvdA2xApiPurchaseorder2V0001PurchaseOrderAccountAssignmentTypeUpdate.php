...
/**
 * ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurchaseOrderAccountAssignmentTypeUpdate Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\SAP\PurchaseOrder
 * @author   OpenAPI Generator team
 ...
 */
class ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurchaseOrderAccountAssignmentTypeUpdate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'com.sap.gateway.srvd_a2x.api_purchaseorder_2.v0001.PurchaseOrderAccountAssignment_Type-update';
    ...
    */
    ...
    public function setCostCenter($cost_center)
    {
        ...
        if ((mb_strlen($cost_center) > 10)) {
            throw new \InvalidArgumentException('invalid length for $cost_center when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurchaseOrderAccountAssignmentTypeUpdate., must be smaller than or equal to 10.');
        }
    ...
    public function setMasterFixedAsset($master_fixed_asset)
    {
        ...
        if ((mb_strlen($master_fixed_asset) > 12)) {
            throw new \InvalidArgumentException('invalid length for $master_fixed_asset when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurchaseOrderAccountAssignmentTypeUpdate., must be smaller than or equal to 12.');
        }
    ...
    public function setProjectNetwork($project_network)
    {
        ...
        if ((mb_strlen($project_network) > 12)) {
            throw new \InvalidArgumentException('invalid length for $project_network when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurchaseOrderAccountAssignmentTypeUpdate., must be smaller than or equal to 12.');
        }
    ...
    public function setNetworkActivity($network_activity)
    {
        ...
        if ((mb_strlen($network_activity) > 4)) {
            throw new \InvalidArgumentException('invalid length for $network_activity when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurchaseOrderAccountAssignmentTypeUpdate., must be smaller than or equal to 4.');
        }
    ...
    public function setOrderQuantityUnit($order_quantity_unit)
    {
        ...
        if ((mb_strlen($order_quantity_unit) > 3)) {
            throw new \InvalidArgumentException('invalid length for $order_quantity_unit when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurchaseOrderAccountAssignmentTypeUpdate., must be smaller than or equal to 3.');
        }
    ...
    public function setDocumentCurrency($document_currency)
    {
        ...
        if ((mb_strlen($document_currency) > 3)) {
            throw new \InvalidArgumentException('invalid length for $document_currency when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurchaseOrderAccountAssignmentTypeUpdate., must be smaller than or equal to 3.');
        }
    ...
    public function setGlAccount($gl_account)
    {
        ...
        if ((mb_strlen($gl_account) > 10)) {
            throw new \InvalidArgumentException('invalid length for $gl_account when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurchaseOrderAccountAssignmentTypeUpdate., must be smaller than or equal to 10.');
        }
    ...
    public function setBusinessArea($business_area)
    {
        ...
        if ((mb_strlen($business_area) > 4)) {
            throw new \InvalidArgumentException('invalid length for $business_area when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurchaseOrderAccountAssignmentTypeUpdate., must be smaller than or equal to 4.');
        }
    ...
    public function setSalesOrder($sales_order)
    {
        ...
        if ((mb_strlen($sales_order) > 10)) {
            throw new \InvalidArgumentException('invalid length for $sales_order when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurchaseOrderAccountAssignmentTypeUpdate., must be smaller than or equal to 10.');
        }
    ...
    public function setSalesOrderItem($sales_order_item)
    {
        ...
        if ((mb_strlen($sales_order_item) > 6)) {
            throw new \InvalidArgumentException('invalid length for $sales_order_item when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurchaseOrderAccountAssignmentTypeUpdate., must be smaller than or equal to 6.');
        }
    ...
    public function setSalesOrderScheduleLine($sales_order_schedule_line)
    {
        ...
        if ((mb_strlen($sales_order_schedule_line) > 4)) {
            throw new \InvalidArgumentException('invalid length for $sales_order_schedule_line when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurchaseOrderAccountAssignmentTypeUpdate., must be smaller than or equal to 4.');
        }
    ...
    public function setFixedAsset($fixed_asset)
    {
        ...
        if ((mb_strlen($fixed_asset) > 4)) {
            throw new \InvalidArgumentException('invalid length for $fixed_asset when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurchaseOrderAccountAssignmentTypeUpdate., must be smaller than or equal to 4.');
        }
    ...
    public function setOrderId($order_id)
    {
        ...
        if ((mb_strlen($order_id) > 12)) {
            throw new \InvalidArgumentException('invalid length for $order_id when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurchaseOrderAccountAssignmentTypeUpdate., must be smaller than or equal to 12.');
        }
    ...
    public function setUnloadingPointName($unloading_point_name)
    {
        ...
        if ((mb_strlen($unloading_point_name) > 25)) {
            throw new \InvalidArgumentException('invalid length for $unloading_point_name when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurchaseOrderAccountAssignmentTypeUpdate., must be smaller than or equal to 25.');
        }
    ...
    public function setControllingArea($controlling_area)
    {
        ...
        if ((mb_strlen($controlling_area) > 4)) {
            throw new \InvalidArgumentException('invalid length for $controlling_area when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurchaseOrderAccountAssignmentTypeUpdate., must be smaller than or equal to 4.');
        }
    ...
    public function setCostObject($cost_object)
    {
        ...
        if ((mb_strlen($cost_object) > 12)) {
            throw new \InvalidArgumentException('invalid length for $cost_object when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurchaseOrderAccountAssignmentTypeUpdate., must be smaller than or equal to 12.');
        }
    ...
    public function setProfitCenter($profit_center)
    {
        ...
        if ((mb_strlen($profit_center) > 10)) {
            throw new \InvalidArgumentException('invalid length for $profit_center when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurchaseOrderAccountAssignmentTypeUpdate., must be smaller than or equal to 10.');
        }
    ...
    public function setWbsElementInternalId($wbs_element_internal_id)
    {
        ...
        if ((mb_strlen($wbs_element_internal_id) > 8)) {
            throw new \InvalidArgumentException('invalid length for $wbs_element_internal_id when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurchaseOrderAccountAssignmentTypeUpdate., must be smaller than or equal to 8.');
        }
    ...
    public function setWbsElementExternalId($wbs_element_external_id)
    {
        ...
        if ((mb_strlen($wbs_element_external_id) > 24)) {
            throw new \InvalidArgumentException('invalid length for $wbs_element_external_id when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurchaseOrderAccountAssignmentTypeUpdate., must be smaller than or equal to 24.');
        }
    ...
    public function setProjectNetworkInternalId($project_network_internal_id)
    {
        ...
        if ((mb_strlen($project_network_internal_id) > 10)) {
            throw new \InvalidArgumentException('invalid length for $project_network_internal_id when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurchaseOrderAccountAssignmentTypeUpdate., must be smaller than or equal to 10.');
        }
    ...
    public function setCommitmentItemShortId($commitment_item_short_id)
    {
        ...
        if ((mb_strlen($commitment_item_short_id) > 14)) {
            throw new \InvalidArgumentException('invalid length for $commitment_item_short_id when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurchaseOrderAccountAssignmentTypeUpdate., must be smaller than or equal to 14.');
        }
    ...
    public function setFundsCenter($funds_center)
    {
        ...
        if ((mb_strlen($funds_center) > 16)) {
            throw new \InvalidArgumentException('invalid length for $funds_center when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurchaseOrderAccountAssignmentTypeUpdate., must be smaller than or equal to 16.');
        }
    ...
    public function setFund($fund)
    {
        ...
        if ((mb_strlen($fund) > 10)) {
            throw new \InvalidArgumentException('invalid length for $fund when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurchaseOrderAccountAssignmentTypeUpdate., must be smaller than or equal to 10.');
        }
    ...
    public function setFunctionalArea($functional_area)
    {
        ...
        if ((mb_strlen($functional_area) > 16)) {
            throw new \InvalidArgumentException('invalid length for $functional_area when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurchaseOrderAccountAssignmentTypeUpdate., must be smaller than or equal to 16.');
        }
    ...
    public function setGoodsRecipientName($goods_recipient_name)
    {
        ...
        if ((mb_strlen($goods_recipient_name) > 12)) {
            throw new \InvalidArgumentException('invalid length for $goods_recipient_name when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurchaseOrderAccountAssignmentTypeUpdate., must be smaller than or equal to 12.');
        }
    ...
    public function setNetworkActivityInternalId($network_activity_internal_id)
    {
        ...
        if ((mb_strlen($network_activity_internal_id) > 8)) {
            throw new \InvalidArgumentException('invalid length for $network_activity_internal_id when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurchaseOrderAccountAssignmentTypeUpdate., must be smaller than or equal to 8.');
        }
    ...
    public function setPartnerAccountNumber($partner_account_number)
    {
        ...
        if ((mb_strlen($partner_account_number) > 10)) {
            throw new \InvalidArgumentException('invalid length for $partner_account_number when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurchaseOrderAccountAssignmentTypeUpdate., must be smaller than or equal to 10.');
        }
    ...
    public function setJointVentureRecoveryCode($joint_venture_recovery_code)
    {
        ...
        if ((mb_strlen($joint_venture_recovery_code) > 2)) {
            throw new \InvalidArgumentException('invalid length for $joint_venture_recovery_code when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurchaseOrderAccountAssignmentTypeUpdate., must be smaller than or equal to 2.');
        }
    ...
    public function setOrderInternalId($order_internal_id)
    {
        ...
        if ((mb_strlen($order_internal_id) > 10)) {
            throw new \InvalidArgumentException('invalid length for $order_internal_id when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurchaseOrderAccountAssignmentTypeUpdate., must be smaller than or equal to 10.');
        }
    ...
    public function setOrderIntBillOfOperationsItem($order_int_bill_of_operations_item)
    {
        ...
        if ((mb_strlen($order_int_bill_of_operations_item) > 8)) {
            throw new \InvalidArgumentException('invalid length for $order_int_bill_of_operations_item when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurchaseOrderAccountAssignmentTypeUpdate., must be smaller than or equal to 8.');
        }
    ...
    public function setTaxCode($tax_code)
    {
        ...
        if ((mb_strlen($tax_code) > 2)) {
            throw new \InvalidArgumentException('invalid length for $tax_code when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurchaseOrderAccountAssignmentTypeUpdate., must be smaller than or equal to 2.');
        }
    ...
    public function setTaxJurisdiction($tax_jurisdiction)
    {
        ...
        if ((mb_strlen($tax_jurisdiction) > 15)) {
            throw new \InvalidArgumentException('invalid length for $tax_jurisdiction when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurchaseOrderAccountAssignmentTypeUpdate., must be smaller than or equal to 15.');
        }
    ...
    public function setCostCtrActivityType($cost_ctr_activity_type)
    {
        ...
        if ((mb_strlen($cost_ctr_activity_type) > 6)) {
            throw new \InvalidArgumentException('invalid length for $cost_ctr_activity_type when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurchaseOrderAccountAssignmentTypeUpdate., must be smaller than or equal to 6.');
        }
    ...
    public function setBusinessProcess($business_process)
    {
        ...
        if ((mb_strlen($business_process) > 12)) {
            throw new \InvalidArgumentException('invalid length for $business_process when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurchaseOrderAccountAssignmentTypeUpdate., must be smaller than or equal to 12.');
        }
    ...
    public function setGrantId($grant_id)
    {
        ...
        if ((mb_strlen($grant_id) > 20)) {
            throw new \InvalidArgumentException('invalid length for $grant_id when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurchaseOrderAccountAssignmentTypeUpdate., must be smaller than or equal to 20.');
        }
    ...
    public function setBudgetPeriod($budget_period)
    {
        ...
        if ((mb_strlen($budget_period) > 10)) {
            throw new \InvalidArgumentException('invalid length for $budget_period when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurchaseOrderAccountAssignmentTypeUpdate., must be smaller than or equal to 10.');
        }
    ...
    public function setEarmarkedFundsDocument($earmarked_funds_document)
    {
        ...
        if ((mb_strlen($earmarked_funds_document) > 10)) {
            throw new \InvalidArgumentException('invalid length for $earmarked_funds_document when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurchaseOrderAccountAssignmentTypeUpdate., must be smaller than or equal to 10.');
        }
    ...
    public function setEarmarkedFundsDocumentItem($earmarked_funds_document_item)
    {
        ...
        if ((mb_strlen($earmarked_funds_document_item) > 3)) {
            throw new \InvalidArgumentException('invalid length for $earmarked_funds_document_item when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurchaseOrderAccountAssignmentTypeUpdate., must be smaller than or equal to 3.');
        }
    ...
    public function setChartOfAccounts($chart_of_accounts)
    {
        ...
        if ((mb_strlen($chart_of_accounts) > 4)) {
            throw new \InvalidArgumentException('invalid length for $chart_of_accounts when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurchaseOrderAccountAssignmentTypeUpdate., must be smaller than or equal to 4.');
        }
    ...
    public function setServiceDocumentType($service_document_type)
    {
        ...
        if ((mb_strlen($service_document_type) > 4)) {
            throw new \InvalidArgumentException('invalid length for $service_document_type when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurchaseOrderAccountAssignmentTypeUpdate., must be smaller than or equal to 4.');
        }
    ...
    public function setServiceDocument($service_document)
    {
        ...
        if ((mb_strlen($service_document) > 10)) {
            throw new \InvalidArgumentException('invalid length for $service_document when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurchaseOrderAccountAssignmentTypeUpdate., must be smaller than or equal to 10.');
        }
    ...
    public function setServiceDocumentItem($service_document_item)
    {
        ...
        if ((mb_strlen($service_document_item) > 6)) {
            throw new \InvalidArgumentException('invalid length for $service_document_item when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurchaseOrderAccountAssignmentTypeUpdate., must be smaller than or equal to 6.');
        }
    ...
    public function setAcctLineFinalReason($acct_line_final_reason)
    {
        ...
        if ((mb_strlen($acct_line_final_reason) > 2)) {
            throw new \InvalidArgumentException('invalid length for $acct_line_final_reason when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurchaseOrderAccountAssignmentTypeUpdate., must be smaller than or equal to 2.');
        }
    ...
    public function setCompanyCode($company_code)
    {
        ...
        if ((mb_strlen($company_code) > 4)) {
            throw new \InvalidArgumentException('invalid length for $company_code when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurchaseOrderAccountAssignmentTypeUpdate., must be smaller than or equal to 4.');
        }
