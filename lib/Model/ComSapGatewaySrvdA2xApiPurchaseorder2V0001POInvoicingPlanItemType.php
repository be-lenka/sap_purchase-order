<?php
/**
 * ComSapGatewaySrvdA2xApiPurchaseorder2V0001POInvoicingPlanItemType
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * ComSapGatewaySrvdA2xApiPurchaseorder2V0001POInvoicingPlanItemType Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\SAP\PurchaseOrder
 * @author   OpenAPI Generator team
 ...
 */
class ComSapGatewaySrvdA2xApiPurchaseorder2V0001POInvoicingPlanItemType implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'com.sap.gateway.srvd_a2x.api_purchaseorder_2.v0001.POInvoicingPlanItem_Type';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['invoicing_plan_item']) && (mb_strlen($this->container['invoicing_plan_item']) > 6)) {
    ...
    public function setPurchaseOrder($purchase_order)
    {
        ...
        if ((mb_strlen($purchase_order) > 10)) {
            throw new \InvalidArgumentException('invalid length for $purchase_order when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001POInvoicingPlanItemType., must be smaller than or equal to 10.');
        }
    ...
    public function setPurchaseOrderItem($purchase_order_item)
    {
        ...
        if ((mb_strlen($purchase_order_item) > 5)) {
            throw new \InvalidArgumentException('invalid length for $purchase_order_item when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001POInvoicingPlanItemType., must be smaller than or equal to 5.');
        }
     ...
     *
     * @param string|null $invoicing_plan_item Item for billing plan/invoice plan/payment cards
     *
     * @return self
     */
    public function setInvoicingPlanItem($invoicing_plan_item)
    {
        ...
        if ((mb_strlen($invoicing_plan_item) > 6)) {
            throw new \InvalidArgumentException('invalid length for $invoicing_plan_item when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001POInvoicingPlanItemType., must be smaller than or equal to 6.');
        }
    ...
    public function setInvoicingPlan($invoicing_plan)
    {
        ...
        if ((mb_strlen($invoicing_plan) > 10)) {
            throw new \InvalidArgumentException('invalid length for $invoicing_plan when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001POInvoicingPlanItemType., must be smaller than or equal to 10.');
        }
    ...
    public function setTransactionCurrency($transaction_currency)
    {
        ...
        if ((mb_strlen($transaction_currency) > 3)) {
            throw new \InvalidArgumentException('invalid length for $transaction_currency when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001POInvoicingPlanItemType., must be smaller than or equal to 3.');
        }
    ...
    public function setPurchasingOrganization($purchasing_organization)
    {
        ...
        if ((mb_strlen($purchasing_organization) > 4)) {
            throw new \InvalidArgumentException('invalid length for $purchasing_organization when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001POInvoicingPlanItemType., must be smaller than or equal to 4.');
        }
    ...
    public function setPurchasingGroup($purchasing_group)
    {
        ...
        if ((mb_strlen($purchasing_group) > 3)) {
            throw new \InvalidArgumentException('invalid length for $purchasing_group when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001POInvoicingPlanItemType., must be smaller than or equal to 3.');
        }
    ...
    public function setPurchaseOrderType($purchase_order_type)
    {
        ...
        if ((mb_strlen($purchase_order_type) > 4)) {
            throw new \InvalidArgumentException('invalid length for $purchase_order_type when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001POInvoicingPlanItemType., must be smaller than or equal to 4.');
        }
    ...
    public function setPlant($plant)
    {
        ...
        if ((mb_strlen($plant) > 4)) {
            throw new \InvalidArgumentException('invalid length for $plant when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001POInvoicingPlanItemType., must be smaller than or equal to 4.');
        }
