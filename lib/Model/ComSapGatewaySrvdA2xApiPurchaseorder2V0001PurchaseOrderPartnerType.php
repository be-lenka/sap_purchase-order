...
/**
 * ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurchaseOrderPartnerType Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\SAP\PurchaseOrder
 * @author   OpenAPI Generator team
 ...
 */
class ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurchaseOrderPartnerType implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'com.sap.gateway.srvd_a2x.api_purchaseorder_2.v0001.PurchaseOrderPartner_Type';
    ...
    */
    ...
    public function setPurchaseOrder($purchase_order)
    {
        ...
        if ((mb_strlen($purchase_order) > 10)) {
            throw new \InvalidArgumentException('invalid length for $purchase_order when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurchaseOrderPartnerType., must be smaller than or equal to 10.');
        }
    ...
    public function setPartnerFunction($partner_function)
    {
        ...
        if ((mb_strlen($partner_function) > 2)) {
            throw new \InvalidArgumentException('invalid length for $partner_function when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurchaseOrderPartnerType., must be smaller than or equal to 2.');
        }
    ...
    public function setSupplierSubrange($supplier_subrange)
    {
        ...
        if ((mb_strlen($supplier_subrange) > 6)) {
            throw new \InvalidArgumentException('invalid length for $supplier_subrange when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurchaseOrderPartnerType., must be smaller than or equal to 6.');
        }
    ...
    public function setPlant($plant)
    {
        ...
        if ((mb_strlen($plant) > 4)) {
            throw new \InvalidArgumentException('invalid length for $plant when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurchaseOrderPartnerType., must be smaller than or equal to 4.');
        }
    ...
    public function setPurchasingOrganization($purchasing_organization)
    {
        ...
        if ((mb_strlen($purchasing_organization) > 4)) {
            throw new \InvalidArgumentException('invalid length for $purchasing_organization when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurchaseOrderPartnerType., must be smaller than or equal to 4.');
        }
    ...
    public function setPartnerCounter($partner_counter)
    {
        ...
        if ((mb_strlen($partner_counter) > 3)) {
            throw new \InvalidArgumentException('invalid length for $partner_counter when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurchaseOrderPartnerType., must be smaller than or equal to 3.');
        }
    ...
    public function setCreatedByUser($created_by_user)
    {
        ...
        if ((mb_strlen($created_by_user) > 12)) {
            throw new \InvalidArgumentException('invalid length for $created_by_user when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurchaseOrderPartnerType., must be smaller than or equal to 12.');
        }
    ...
    public function setPurchasingDocumentPartnerType($purchasing_document_partner_type)
    {
        ...
        if ((mb_strlen($purchasing_document_partner_type) > 2)) {
            throw new \InvalidArgumentException('invalid length for $purchasing_document_partner_type when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurchaseOrderPartnerType., must be smaller than or equal to 2.');
        }
    ...
    public function setSupplier($supplier)
    {
        ...
        if ((mb_strlen($supplier) > 10)) {
            throw new \InvalidArgumentException('invalid length for $supplier when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurchaseOrderPartnerType., must be smaller than or equal to 10.');
        }
    ...
    public function setSupplierHierarchyCategory($supplier_hierarchy_category)
    {
        ...
        if ((mb_strlen($supplier_hierarchy_category) > 1)) {
            throw new \InvalidArgumentException('invalid length for $supplier_hierarchy_category when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurchaseOrderPartnerType., must be smaller than or equal to 1.');
        }
    ...
    public function setSupplierContact($supplier_contact)
    {
        ...
        if ((mb_strlen($supplier_contact) > 10)) {
            throw new \InvalidArgumentException('invalid length for $supplier_contact when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurchaseOrderPartnerType., must be smaller than or equal to 10.');
        }
    ...
    public function setPersonWorkAgreement($person_work_agreement)
    {
        ...
        if ((mb_strlen($person_work_agreement) > 8)) {
            throw new \InvalidArgumentException('invalid length for $person_work_agreement when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurchaseOrderPartnerType., must be smaller than or equal to 8.');
        }
    ...
    public function setEmploymentInternalId($employment_internal_id)
    {
        ...
        if ((mb_strlen($employment_internal_id) > 8)) {
            throw new \InvalidArgumentException('invalid length for $employment_internal_id when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurchaseOrderPartnerType., must be smaller than or equal to 8.');
        }
