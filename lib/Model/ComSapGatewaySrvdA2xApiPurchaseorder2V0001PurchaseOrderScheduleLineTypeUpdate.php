...
/**
 * ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurchaseOrderScheduleLineTypeUpdate Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\SAP\PurchaseOrder
 * @author   OpenAPI Generator team
 ...
 */
class ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurchaseOrderScheduleLineTypeUpdate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'com.sap.gateway.srvd_a2x.api_purchaseorder_2.v0001.PurchaseOrderScheduleLine_Type-update';
    ...
    */
    ...
    public function setBatch($batch)
    {
        ...
        if ((mb_strlen($batch) > 10)) {
            throw new \InvalidArgumentException('invalid length for $batch when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurchaseOrderScheduleLineTypeUpdate., must be smaller than or equal to 10.');
        }
    ...
    public function setBatchBySupplier($batch_by_supplier)
    {
        ...
        if ((mb_strlen($batch_by_supplier) > 15)) {
            throw new \InvalidArgumentException('invalid length for $batch_by_supplier when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurchaseOrderScheduleLineTypeUpdate., must be smaller than or equal to 15.');
        }
    ...
    public function setCurrency($currency)
    {
        ...
        if ((mb_strlen($currency) > 3)) {
            throw new \InvalidArgumentException('invalid length for $currency when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurchaseOrderScheduleLineTypeUpdate., must be smaller than or equal to 3.');
        }
    ...
    public function setPurchaseRequisition($purchase_requisition)
    {
        ...
        if ((mb_strlen($purchase_requisition) > 10)) {
            throw new \InvalidArgumentException('invalid length for $purchase_requisition when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurchaseOrderScheduleLineTypeUpdate., must be smaller than or equal to 10.');
        }
    ...
    public function setPurchaseRequisitionItem($purchase_requisition_item)
    {
        ...
        if ((mb_strlen($purchase_requisition_item) > 5)) {
            throw new \InvalidArgumentException('invalid length for $purchase_requisition_item when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurchaseOrderScheduleLineTypeUpdate., must be smaller than or equal to 5.');
        }
    ...
    public function setDelivDateCategory($deliv_date_category)
    {
        ...
        if ((mb_strlen($deliv_date_category) > 1)) {
            throw new \InvalidArgumentException('invalid length for $deliv_date_category when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurchaseOrderScheduleLineTypeUpdate., must be smaller than or equal to 1.');
        }
    ...
    public function setRouteSchedule($route_schedule)
    {
        ...
        if ((mb_strlen($route_schedule) > 10)) {
            throw new \InvalidArgumentException('invalid length for $route_schedule when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurchaseOrderScheduleLineTypeUpdate., must be smaller than or equal to 10.');
        }
