<?php
/**
 * ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurchaseOrderItemNoteType
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurchaseOrderItemNoteType Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\SAP\PurchaseOrder
 * @author   OpenAPI Generator team
 ...
 */
class ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurchaseOrderItemNoteType implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'com.sap.gateway.srvd_a2x.api_purchaseorder_2.v0001.PurchaseOrderItemNote_Type';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['text_object_type']) && (mb_strlen($this->container['text_object_type']) > 4)) {
    ...
    public function setPurchaseOrder($purchase_order)
    {
        ...
        if ((mb_strlen($purchase_order) > 10)) {
            throw new \InvalidArgumentException('invalid length for $purchase_order when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurchaseOrderItemNoteType., must be smaller than or equal to 10.');
        }
    ...
    public function setPurchaseOrderItem($purchase_order_item)
    {
        ...
        if ((mb_strlen($purchase_order_item) > 5)) {
            throw new \InvalidArgumentException('invalid length for $purchase_order_item when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurchaseOrderItemNoteType., must be smaller than or equal to 5.');
        }
     ...
     *
     * @param string|null $text_object_type text_object_type
     *
     * @return self
     */
    public function setTextObjectType($text_object_type)
    {
        ...
        if ((mb_strlen($text_object_type) > 4)) {
            throw new \InvalidArgumentException('invalid length for $text_object_type when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurchaseOrderItemNoteType., must be smaller than or equal to 4.');
        }
    ...
    public function setLanguage($language)
    {
        ...
        if ((mb_strlen($language) > 2)) {
            throw new \InvalidArgumentException('invalid length for $language when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurchaseOrderItemNoteType., must be smaller than or equal to 2.');
        }
    ...
    public function setPurchaseOrderItemUniqueId($purchase_order_item_unique_id)
    {
        ...
        if ((mb_strlen($purchase_order_item_unique_id) > 15)) {
            throw new \InvalidArgumentException('invalid length for $purchase_order_item_unique_id when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurchaseOrderItemNoteType., must be smaller than or equal to 15.');
        }
