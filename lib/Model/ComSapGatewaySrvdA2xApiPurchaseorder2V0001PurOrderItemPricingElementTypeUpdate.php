...
/**
 * ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurOrderItemPricingElementTypeUpdate Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\SAP\PurchaseOrder
 * @author   OpenAPI Generator team
 ...
 */
class ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurOrderItemPricingElementTypeUpdate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'com.sap.gateway.srvd_a2x.api_purchaseorder_2.v0001.PurOrderItemPricingElement_Type-update';
    ...
    */
    ...
    public function setConditionType($condition_type)
    {
        ...
        if ((mb_strlen($condition_type) > 4)) {
            throw new \InvalidArgumentException('invalid length for $condition_type when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurOrderItemPricingElementTypeUpdate., must be smaller than or equal to 4.');
        }
    ...
    public function setConditionRateRatioUnit($condition_rate_ratio_unit)
    {
        ...
        if ((mb_strlen($condition_rate_ratio_unit) > 3)) {
            throw new \InvalidArgumentException('invalid length for $condition_rate_ratio_unit when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurOrderItemPricingElementTypeUpdate., must be smaller than or equal to 3.');
        }
    ...
    public function setConditionCurrency($condition_currency)
    {
        ...
        if ((mb_strlen($condition_currency) > 3)) {
            throw new \InvalidArgumentException('invalid length for $condition_currency when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurOrderItemPricingElementTypeUpdate., must be smaller than or equal to 3.');
        }
    ...
    public function setConditionQuantityUnit($condition_quantity_unit)
    {
        ...
        if ((mb_strlen($condition_quantity_unit) > 3)) {
            throw new \InvalidArgumentException('invalid length for $condition_quantity_unit when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurOrderItemPricingElementTypeUpdate., must be smaller than or equal to 3.');
        }
    ...
    public function setAccountKeyForGlAccount($account_key_for_gl_account)
    {
        ...
        if ((mb_strlen($account_key_for_gl_account) > 3)) {
            throw new \InvalidArgumentException('invalid length for $account_key_for_gl_account when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurOrderItemPricingElementTypeUpdate., must be smaller than or equal to 3.');
        }
    ...
    public function setGlAccount($gl_account)
    {
        ...
        if ((mb_strlen($gl_account) > 10)) {
            throw new \InvalidArgumentException('invalid length for $gl_account when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurOrderItemPricingElementTypeUpdate., must be smaller than or equal to 10.');
        }
    ...
    public function setTaxCode($tax_code)
    {
        ...
        if ((mb_strlen($tax_code) > 2)) {
            throw new \InvalidArgumentException('invalid length for $tax_code when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurOrderItemPricingElementTypeUpdate., must be smaller than or equal to 2.');
        }
    ...
    public function setAcctKeyForAccrualsGlAccount($acct_key_for_accruals_gl_account)
    {
        ...
        if ((mb_strlen($acct_key_for_accruals_gl_account) > 3)) {
            throw new \InvalidArgumentException('invalid length for $acct_key_for_accruals_gl_account when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurOrderItemPricingElementTypeUpdate., must be smaller than or equal to 3.');
        }
    ...
    public function setAccrualsGlAccount($accruals_gl_account)
    {
        ...
        if ((mb_strlen($accruals_gl_account) > 10)) {
            throw new \InvalidArgumentException('invalid length for $accruals_gl_account when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurOrderItemPricingElementTypeUpdate., must be smaller than or equal to 10.');
        }
    ...
    public function setWithholdingTaxCode($withholding_tax_code)
    {
        ...
        if ((mb_strlen($withholding_tax_code) > 2)) {
            throw new \InvalidArgumentException('invalid length for $withholding_tax_code when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurOrderItemPricingElementTypeUpdate., must be smaller than or equal to 2.');
        }
    ...
    public function setFreightSupplier($freight_supplier)
    {
        ...
        if ((mb_strlen($freight_supplier) > 10)) {
            throw new \InvalidArgumentException('invalid length for $freight_supplier when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurOrderItemPricingElementTypeUpdate., must be smaller than or equal to 10.');
        }
    ...
    public function setTransactionCurrency($transaction_currency)
    {
        ...
        if ((mb_strlen($transaction_currency) > 3)) {
            throw new \InvalidArgumentException('invalid length for $transaction_currency when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurOrderItemPricingElementTypeUpdate., must be smaller than or equal to 3.');
        }
    ...
    public function setPrcgProcedureCounterForHeader($prcg_procedure_counter_for_header)
    {
        ...
        if ((mb_strlen($prcg_procedure_counter_for_header) > 3)) {
            throw new \InvalidArgumentException('invalid length for $prcg_procedure_counter_for_header when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurOrderItemPricingElementTypeUpdate., must be smaller than or equal to 3.');
        }
    ...
    public function setStructureCondition($structure_condition)
    {
        ...
        if ((mb_strlen($structure_condition) > 1)) {
            throw new \InvalidArgumentException('invalid length for $structure_condition when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurOrderItemPricingElementTypeUpdate., must be smaller than or equal to 1.');
        }
    ...
    public function setConditionAlternativeCurrency($condition_alternative_currency)
    {
        ...
        if ((mb_strlen($condition_alternative_currency) > 3)) {
            throw new \InvalidArgumentException('invalid length for $condition_alternative_currency when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurOrderItemPricingElementTypeUpdate., must be smaller than or equal to 3.');
        }
    ...
    public function setBillingPriceSource($billing_price_source)
    {
        ...
        if ((mb_strlen($billing_price_source) > 1)) {
            throw new \InvalidArgumentException('invalid length for $billing_price_source when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurOrderItemPricingElementTypeUpdate., must be smaller than or equal to 1.');
        }
    ...
    public function setTaxJurisdictionLevel($tax_jurisdiction_level)
    {
        ...
        if ((mb_strlen($tax_jurisdiction_level) > 1)) {
            throw new \InvalidArgumentException('invalid length for $tax_jurisdiction_level when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurOrderItemPricingElementTypeUpdate., must be smaller than or equal to 1.');
        }
    ...
    public function setConditionByteSequence($condition_byte_sequence)
    {
        ...
        if ((mb_strlen($condition_byte_sequence) > 3)) {
            throw new \InvalidArgumentException('invalid length for $condition_byte_sequence when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurOrderItemPricingElementTypeUpdate., must be smaller than or equal to 3.');
        }
    ...
    public function setConditionBasisLimitExceeded($condition_basis_limit_exceeded)
    {
        ...
        if ((mb_strlen($condition_basis_limit_exceeded) > 1)) {
            throw new \InvalidArgumentException('invalid length for $condition_basis_limit_exceeded when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurOrderItemPricingElementTypeUpdate., must be smaller than or equal to 1.');
        }
    ...
    public function setConditionAmountLimitExceeded($condition_amount_limit_exceeded)
    {
        ...
        if ((mb_strlen($condition_amount_limit_exceeded) > 1)) {
            throw new \InvalidArgumentException('invalid length for $condition_amount_limit_exceeded when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurOrderItemPricingElementTypeUpdate., must be smaller than or equal to 1.');
        }
    ...
    public function setCustomerRebateRecipient($customer_rebate_recipient)
    {
        ...
        if ((mb_strlen($customer_rebate_recipient) > 10)) {
            throw new \InvalidArgumentException('invalid length for $customer_rebate_recipient when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurOrderItemPricingElementTypeUpdate., must be smaller than or equal to 10.');
        }
    ...
    public function setVariantCondition($variant_condition)
    {
        ...
        if ((mb_strlen($variant_condition) > 26)) {
            throw new \InvalidArgumentException('invalid length for $variant_condition when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurOrderItemPricingElementTypeUpdate., must be smaller than or equal to 26.');
        }
    ...
    public function setConditionAcctAssgmtRelevance($condition_acct_assgmt_relevance)
    {
        ...
        if ((mb_strlen($condition_acct_assgmt_relevance) > 1)) {
            throw new \InvalidArgumentException('invalid length for $condition_acct_assgmt_relevance when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurOrderItemPricingElementTypeUpdate., must be smaller than or equal to 1.');
        }
    ...
    public function setConditionMatrixMaintRelevance($condition_matrix_maint_relevance)
    {
        ...
        if ((mb_strlen($condition_matrix_maint_relevance) > 1)) {
            throw new \InvalidArgumentException('invalid length for $condition_matrix_maint_relevance when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurOrderItemPricingElementTypeUpdate., must be smaller than or equal to 1.');
        }
    ...
    public function setConditionTypeName($condition_type_name)
    {
        ...
        if ((mb_strlen($condition_type_name) > 30)) {
            throw new \InvalidArgumentException('invalid length for $condition_type_name when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurOrderItemPricingElementTypeUpdate., must be smaller than or equal to 30.');
        }
    ...
    public function setTaxCodeName($tax_code_name)
    {
        ...
        if ((mb_strlen($tax_code_name) > 50)) {
            throw new \InvalidArgumentException('invalid length for $tax_code_name when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurOrderItemPricingElementTypeUpdate., must be smaller than or equal to 50.');
        }
    ...
    public function setPricingProcedure($pricing_procedure)
    {
        ...
        if ((mb_strlen($pricing_procedure) > 6)) {
            throw new \InvalidArgumentException('invalid length for $pricing_procedure when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurOrderItemPricingElementTypeUpdate., must be smaller than or equal to 6.');
        }
    ...
    public function setSuperordinateDocument($superordinate_document)
    {
        ...
        if ((mb_strlen($superordinate_document) > 32)) {
            throw new \InvalidArgumentException('invalid length for $superordinate_document when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurOrderItemPricingElementTypeUpdate., must be smaller than or equal to 32.');
        }
    ...
    public function setSuperordinateDocumentItem($superordinate_document_item)
    {
        ...
        if ((mb_strlen($superordinate_document_item) > 70)) {
            throw new \InvalidArgumentException('invalid length for $superordinate_document_item when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurOrderItemPricingElementTypeUpdate., must be smaller than or equal to 70.');
        }
