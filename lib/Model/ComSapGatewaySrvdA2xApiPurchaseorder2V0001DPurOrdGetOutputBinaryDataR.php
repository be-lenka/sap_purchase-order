...
/**
 * ComSapGatewaySrvdA2xApiPurchaseorder2V0001DPurOrdGetOutputBinaryDataR Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\SAP\PurchaseOrder
 * @author   OpenAPI Generator team
 ...
 */
class ComSapGatewaySrvdA2xApiPurchaseorder2V0001DPurOrdGetOutputBinaryDataR implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'com.sap.gateway.srvd_a2x.api_purchaseorder_2.v0001.D_PurOrdGetOutputBinaryDataR';
    ...
    */
    ...
    public function setMimeType($mime_type)
    {
        ...
        if ((mb_strlen($mime_type) > 128)) {
            throw new \InvalidArgumentException('invalid length for $mime_type when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001DPurOrdGetOutputBinaryDataR., must be smaller than or equal to 128.');
        }
    ...
    public function setOutputChannel($output_channel)
    {
        ...
        if ((mb_strlen($output_channel) > 5)) {
            throw new \InvalidArgumentException('invalid length for $output_channel when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001DPurOrdGetOutputBinaryDataR., must be smaller than or equal to 5.');
        }
    ...
    public function setOutputDocumentName($output_document_name)
    {
        ...
        if ((mb_strlen($output_document_name) > 120)) {
            throw new \InvalidArgumentException('invalid length for $output_document_name when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001DPurOrdGetOutputBinaryDataR., must be smaller than or equal to 120.');
        }
    ...
    public function setRecipient($recipient)
    {
        ...
        if ((mb_strlen($recipient) > 10)) {
            throw new \InvalidArgumentException('invalid length for $recipient when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001DPurOrdGetOutputBinaryDataR., must be smaller than or equal to 10.');
        }
    ...
    public function setRecipientRole($recipient_role)
    {
        ...
        if ((mb_strlen($recipient_role) > 2)) {
            throw new \InvalidArgumentException('invalid length for $recipient_role when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001DPurOrdGetOutputBinaryDataR., must be smaller than or equal to 2.');
        }
