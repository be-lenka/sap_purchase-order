...
/**
 * ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurchaseOrderType Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\SAP\PurchaseOrder
 * @author   OpenAPI Generator team
 ...
 */
class ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurchaseOrderType implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'com.sap.gateway.srvd_a2x.api_purchaseorder_2.v0001.PurchaseOrder_Type';
    ...
    protected static $openAPITypes = [
        ...
        'purchase_order_subtype' => 'string',
        'purchasing_document_origin' => 'string',
        ...
        'language' => 'string',
        'purchase_order_deletion_code' => 'string',
        'release_is_not_completed' => 'bool',
        'purchasing_completeness_status' => 'bool',
        'purchasing_processing_status' => 'string',
        ...
        'supplier' => 'string',
        'manual_supplier_address_id' => 'string',
        ...
        'purg_aggrgd_prod_cmplnc_suplr_sts' => 'string',
        'purg_aggrgd_prod_marketability_sts' => 'string',
        'purg_aggrgd_sfty_data_sheet_status' => 'string',
        'purg_prod_cmplnc_tot_dngrs_goods_sts' => 'string',
        ...
        '_purchase_order_note' => '\BeLenka\SAP\PurchaseOrder\Model\ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurchaseOrderNoteType[]',
        '_purchase_order_partner' => '\BeLenka\SAP\PurchaseOrder\Model\ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurchaseOrderPartnerType[]',
        '_supplier_address' => '\BeLenka\SAP\PurchaseOrder\Model\ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurchaseOrderSupplierAddressType'
    ];
    ...
    protected static $openAPIFormats = [
        ...
        'purchase_order_subtype' => null,
        'purchasing_document_origin' => null,
        ...
        'language' => null,
        'purchase_order_deletion_code' => null,
        'release_is_not_completed' => null,
        'purchasing_completeness_status' => null,
        'purchasing_processing_status' => null,
        ...
        'supplier' => null,
        'manual_supplier_address_id' => null,
        ...
        'purg_aggrgd_prod_cmplnc_suplr_sts' => null,
        'purg_aggrgd_prod_marketability_sts' => null,
        'purg_aggrgd_sfty_data_sheet_status' => null,
        'purg_prod_cmplnc_tot_dngrs_goods_sts' => null,
    ...
    protected static array $openAPINullables = [
		...
		'purchase_order_subtype' => false,
		'purchasing_document_origin' => false,
		...
		'language' => false,
		'purchase_order_deletion_code' => false,
		'release_is_not_completed' => false,
		'purchasing_completeness_status' => false,
		'purchasing_processing_status' => false,
		...
		'supplier' => false,
		'manual_supplier_address_id' => false,
		...
		'purg_aggrgd_prod_cmplnc_suplr_sts' => false,
		'purg_aggrgd_prod_marketability_sts' => false,
		'purg_aggrgd_sfty_data_sheet_status' => false,
		'purg_prod_cmplnc_tot_dngrs_goods_sts' => false,
    ...
    protected static $attributeMap = [
        ...
        'language' => 'Language',
        'purchase_order_deletion_code' => 'PurchaseOrderDeletionCode',
        'release_is_not_completed' => 'ReleaseIsNotCompleted',
        'purchasing_completeness_status' => 'PurchasingCompletenessStatus',
        'purchasing_processing_status' => 'PurchasingProcessingStatus',
        ...
        'purg_aggrgd_prod_cmplnc_suplr_sts' => 'PurgAggrgdProdCmplncSuplrSts',
        'purg_aggrgd_prod_marketability_sts' => 'PurgAggrgdProdMarketabilitySts',
        'purg_aggrgd_sfty_data_sheet_status' => 'PurgAggrgdSftyDataSheetStatus',
        'purg_prod_cmplnc_tot_dngrs_goods_sts' => 'PurgProdCmplncTotDngrsGoodsSts',
    ...
    protected static $setters = [
        ...
        'purchase_order_subtype' => 'setPurchaseOrderSubtype',
        'purchasing_document_origin' => 'setPurchasingDocumentOrigin',
        ...
        'purchase_order_deletion_code' => 'setPurchaseOrderDeletionCode',
        'release_is_not_completed' => 'setReleaseIsNotCompleted',
        'purchasing_completeness_status' => 'setPurchasingCompletenessStatus',
        'purchasing_processing_status' => 'setPurchasingProcessingStatus',
        ...
        'manual_supplier_address_id' => 'setManualSupplierAddressId',
        ...
        'purg_aggrgd_prod_cmplnc_suplr_sts' => 'setPurgAggrgdProdCmplncSuplrSts',
        'purg_aggrgd_prod_marketability_sts' => 'setPurgAggrgdProdMarketabilitySts',
        'purg_aggrgd_sfty_data_sheet_status' => 'setPurgAggrgdSftyDataSheetStatus',
    ...
    protected static $getters = [
        ...
        'purchase_order_subtype' => 'getPurchaseOrderSubtype',
        'purchasing_document_origin' => 'getPurchasingDocumentOrigin',
        ...
        'purchase_order_deletion_code' => 'getPurchaseOrderDeletionCode',
        'release_is_not_completed' => 'getReleaseIsNotCompleted',
        'purchasing_completeness_status' => 'getPurchasingCompletenessStatus',
        'purchasing_processing_status' => 'getPurchasingProcessingStatus',
        ...
        'manual_supplier_address_id' => 'getManualSupplierAddressId',
        ...
        'purg_aggrgd_prod_cmplnc_suplr_sts' => 'getPurgAggrgdProdCmplncSuplrSts',
        'purg_aggrgd_prod_marketability_sts' => 'getPurgAggrgdProdMarketabilitySts',
        'purg_aggrgd_sfty_data_sheet_status' => 'getPurgAggrgdSftyDataSheetStatus',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('purchase_order_subtype', $data ?? [], null);
        $this->setIfExists('purchasing_document_origin', $data ?? [], null);
        ...
        $this->setIfExists('purchase_order_deletion_code', $data ?? [], null);
        $this->setIfExists('release_is_not_completed', $data ?? [], null);
        $this->setIfExists('purchasing_completeness_status', $data ?? [], null);
        $this->setIfExists('purchasing_processing_status', $data ?? [], null);
        ...
        $this->setIfExists('manual_supplier_address_id', $data ?? [], null);
        ...
        $this->setIfExists('purg_aggrgd_prod_cmplnc_suplr_sts', $data ?? [], null);
        $this->setIfExists('purg_aggrgd_prod_marketability_sts', $data ?? [], null);
        $this->setIfExists('purg_aggrgd_sfty_data_sheet_status', $data ?? [], null);
        $this->setIfExists('purg_prod_cmplnc_tot_dngrs_goods_sts', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['purchase_order_subtype']) && (mb_strlen($this->container['purchase_order_subtype']) > 1)) {
            $invalidProperties[] = "invalid value for 'purchase_order_subtype', the character length must be smaller than or equal to 1.";
        }

        if (!is_null($this->container['purchasing_document_origin']) && (mb_strlen($this->container['purchasing_document_origin']) > 1)) {
            $invalidProperties[] = "invalid value for 'purchasing_document_origin', the character length must be smaller than or equal to 1.";
        }
        ...
        if (!is_null($this->container['purchase_order_deletion_code']) && (mb_strlen($this->container['purchase_order_deletion_code']) > 1)) {
            $invalidProperties[] = "invalid value for 'purchase_order_deletion_code', the character length must be smaller than or equal to 1.";
        }

        if (!is_null($this->container['purchasing_processing_status']) && (mb_strlen($this->container['purchasing_processing_status']) > 2)) {
            $invalidProperties[] = "invalid value for 'purchasing_processing_status', the character length must be smaller than or equal to 2.";
        }
        ...
        if (!is_null($this->container['manual_supplier_address_id']) && (mb_strlen($this->container['manual_supplier_address_id']) > 10)) {
            $invalidProperties[] = "invalid value for 'manual_supplier_address_id', the character length must be smaller than or equal to 10.";
        }
        ...
        if (!is_null($this->container['purg_aggrgd_prod_cmplnc_suplr_sts']) && (mb_strlen($this->container['purg_aggrgd_prod_cmplnc_suplr_sts']) > 1)) {
            $invalidProperties[] = "invalid value for 'purg_aggrgd_prod_cmplnc_suplr_sts', the character length must be smaller than or equal to 1.";
        }

        if (!is_null($this->container['purg_aggrgd_prod_marketability_sts']) && (mb_strlen($this->container['purg_aggrgd_prod_marketability_sts']) > 1)) {
            $invalidProperties[] = "invalid value for 'purg_aggrgd_prod_marketability_sts', the character length must be smaller than or equal to 1.";
        }

        if (!is_null($this->container['purg_aggrgd_sfty_data_sheet_status']) && (mb_strlen($this->container['purg_aggrgd_sfty_data_sheet_status']) > 1)) {
            $invalidProperties[] = "invalid value for 'purg_aggrgd_sfty_data_sheet_status', the character length must be smaller than or equal to 1.";
        }

        if (!is_null($this->container['purg_prod_cmplnc_tot_dngrs_goods_sts']) && (mb_strlen($this->container['purg_prod_cmplnc_tot_dngrs_goods_sts']) > 1)) {
            $invalidProperties[] = "invalid value for 'purg_prod_cmplnc_tot_dngrs_goods_sts', the character length must be smaller than or equal to 1.";
        }
    ...
    public function setPurchaseOrder($purchase_order)
    {
        ...
        if ((mb_strlen($purchase_order) > 10)) {
            throw new \InvalidArgumentException('invalid length for $purchase_order when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurchaseOrderType., must be smaller than or equal to 10.');
        }
    ...
    public function setPurchaseOrderType($purchase_order_type)
    {
        ...
        if ((mb_strlen($purchase_order_type) > 4)) {
            throw new \InvalidArgumentException('invalid length for $purchase_order_type when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurchaseOrderType., must be smaller than or equal to 4.');
        }
    ...
    /**
     * Gets purchase_order_subtype
     *
     * @return string|null
     */
    public function getPurchaseOrderSubtype()
    {
        return $this->container['purchase_order_subtype'];
    }

    /**
     * Sets purchase_order_subtype
     *
     * @param string|null $purchase_order_subtype Control indicator for purchasing document type
     *
     * @return self
     */
    public function setPurchaseOrderSubtype($purchase_order_subtype)
    {
        if (is_null($purchase_order_subtype)) {
            throw new \InvalidArgumentException('non-nullable purchase_order_subtype cannot be null');
        }
        if ((mb_strlen($purchase_order_subtype) > 1)) {
            throw new \InvalidArgumentException('invalid length for $purchase_order_subtype when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurchaseOrderType., must be smaller than or equal to 1.');
        }

        $this->container['purchase_order_subtype'] = $purchase_order_subtype;

        return $this;
    }

    /**
     * Gets purchasing_document_origin
     *
     * @return string|null
     */
    public function getPurchasingDocumentOrigin()
    {
        return $this->container['purchasing_document_origin'];
    }

    /**
     * Sets purchasing_document_origin
     *
     * @param string|null $purchasing_document_origin Status of Purchasing Document
     *
     * @return self
     */
    public function setPurchasingDocumentOrigin($purchasing_document_origin)
    {
        if (is_null($purchasing_document_origin)) {
            throw new \InvalidArgumentException('non-nullable purchasing_document_origin cannot be null');
        }
        if ((mb_strlen($purchasing_document_origin) > 1)) {
            throw new \InvalidArgumentException('invalid length for $purchasing_document_origin when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurchaseOrderType., must be smaller than or equal to 1.');
        }

        $this->container['purchasing_document_origin'] = $purchasing_document_origin;
    ...
    public function setPurchasingDocumentProcessCode($purchasing_document_process_code)
    {
        ...
        if ((mb_strlen($purchasing_document_process_code) > 3)) {
            throw new \InvalidArgumentException('invalid length for $purchasing_document_process_code when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurchaseOrderType., must be smaller than or equal to 3.');
        }
     ...
     *
     * @param string|null $created_by_user User of person who created a purchasing document
     *
     * @return self
     */
    public function setCreatedByUser($created_by_user)
    {
        ...
        if ((mb_strlen($created_by_user) > 12)) {
            throw new \InvalidArgumentException('invalid length for $created_by_user when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurchaseOrderType., must be smaller than or equal to 12.');
        }
     ...
     * Sets creation_date
     *
     * @param \DateTime|null $creation_date Creation Date of Purchasing Document
     *
     * @return self
     */
    ...
    public function setLanguage($language)
    {
        ...
        if ((mb_strlen($language) > 2)) {
            throw new \InvalidArgumentException('invalid length for $language when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurchaseOrderType., must be smaller than or equal to 2.');
        }
    ...
    /**
     * Gets purchase_order_deletion_code
     *
     * @return string|null
     */
    public function getPurchaseOrderDeletionCode()
    {
        return $this->container['purchase_order_deletion_code'];
    }

    /**
     * Sets purchase_order_deletion_code
     *
     * @param string|null $purchase_order_deletion_code Purchase Order Deletion Code
     *
     * @return self
     */
    public function setPurchaseOrderDeletionCode($purchase_order_deletion_code)
    {
        if (is_null($purchase_order_deletion_code)) {
            throw new \InvalidArgumentException('non-nullable purchase_order_deletion_code cannot be null');
        }
        if ((mb_strlen($purchase_order_deletion_code) > 1)) {
            throw new \InvalidArgumentException('invalid length for $purchase_order_deletion_code when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurchaseOrderType., must be smaller than or equal to 1.');
        }

        $this->container['purchase_order_deletion_code'] = $purchase_order_deletion_code;

        return $this;
    }

    /**
     * Gets release_is_not_completed
     *
     * @return bool|null
     */
    public function getReleaseIsNotCompleted()
    {
        return $this->container['release_is_not_completed'];
    }

    /**
     * Sets release_is_not_completed
     *
     * @param bool|null $release_is_not_completed Release Not Yet Completely Effected
     *
     * @return self
     */
    public function setReleaseIsNotCompleted($release_is_not_completed)
    {
        if (is_null($release_is_not_completed)) {
            throw new \InvalidArgumentException('non-nullable release_is_not_completed cannot be null');
        }
        $this->container['release_is_not_completed'] = $release_is_not_completed;
    ...
    /**
     * Gets purchasing_processing_status
     *
     * @return string|null
     */
    public function getPurchasingProcessingStatus()
    {
        return $this->container['purchasing_processing_status'];
    }

    /**
     * Sets purchasing_processing_status
     *
     * @param string|null $purchasing_processing_status Purchasing Document Processing State
     *
     * @return self
     */
    public function setPurchasingProcessingStatus($purchasing_processing_status)
    {
        if (is_null($purchasing_processing_status)) {
            throw new \InvalidArgumentException('non-nullable purchasing_processing_status cannot be null');
        }
        if ((mb_strlen($purchasing_processing_status) > 2)) {
            throw new \InvalidArgumentException('invalid length for $purchasing_processing_status when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurchaseOrderType., must be smaller than or equal to 2.');
        }

        $this->container['purchasing_processing_status'] = $purchasing_processing_status;
    ...
    public function setPurgReleaseSequenceStatus($purg_release_sequence_status)
    {
        ...
        if ((mb_strlen($purg_release_sequence_status) > 8)) {
            throw new \InvalidArgumentException('invalid length for $purg_release_sequence_status when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurchaseOrderType., must be smaller than or equal to 8.');
        }
    ...
    public function setReleaseCode($release_code)
    {
        ...
        if ((mb_strlen($release_code) > 1)) {
            throw new \InvalidArgumentException('invalid length for $release_code when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurchaseOrderType., must be smaller than or equal to 1.');
        }
    ...
    public function setPurchasingReleaseStrategy($purchasing_release_strategy)
    {
        ...
        if ((mb_strlen($purchasing_release_strategy) > 2)) {
            throw new \InvalidArgumentException('invalid length for $purchasing_release_strategy when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurchaseOrderType., must be smaller than or equal to 2.');
        }
    ...
    public function setPurgReasonForDocCancellation($purg_reason_for_doc_cancellation)
    {
        ...
        if ((mb_strlen($purg_reason_for_doc_cancellation) > 2)) {
            throw new \InvalidArgumentException('invalid length for $purg_reason_for_doc_cancellation when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurchaseOrderType., must be smaller than or equal to 2.');
        }
    ...
    public function setCompanyCode($company_code)
    {
        ...
        if ((mb_strlen($company_code) > 4)) {
            throw new \InvalidArgumentException('invalid length for $company_code when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurchaseOrderType., must be smaller than or equal to 4.');
        }
    ...
    public function setPurchasingOrganization($purchasing_organization)
    {
        ...
        if ((mb_strlen($purchasing_organization) > 4)) {
            throw new \InvalidArgumentException('invalid length for $purchasing_organization when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurchaseOrderType., must be smaller than or equal to 4.');
        }
    ...
    public function setPurchasingGroup($purchasing_group)
    {
        ...
        if ((mb_strlen($purchasing_group) > 3)) {
            throw new \InvalidArgumentException('invalid length for $purchasing_group when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurchaseOrderType., must be smaller than or equal to 3.');
        }
    ...
    public function setSupplier($supplier)
    {
        ...
        if ((mb_strlen($supplier) > 10)) {
            throw new \InvalidArgumentException('invalid length for $supplier when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurchaseOrderType., must be smaller than or equal to 10.');
        }
    ...
    /**
     * Gets manual_supplier_address_id
     *
     * @return string|null
     */
    public function getManualSupplierAddressId()
    {
        return $this->container['manual_supplier_address_id'];
    }

    /**
     * Sets manual_supplier_address_id
     *
     * @param string|null $manual_supplier_address_id manual_supplier_address_id
     *
     * @return self
     */
    public function setManualSupplierAddressId($manual_supplier_address_id)
    {
        if (is_null($manual_supplier_address_id)) {
            throw new \InvalidArgumentException('non-nullable manual_supplier_address_id cannot be null');
        }
        if ((mb_strlen($manual_supplier_address_id) > 10)) {
            throw new \InvalidArgumentException('invalid length for $manual_supplier_address_id when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurchaseOrderType., must be smaller than or equal to 10.');
        }

        $this->container['manual_supplier_address_id'] = $manual_supplier_address_id;
    ...
    public function setSupplierAddressId($supplier_address_id)
    {
        ...
        if ((mb_strlen($supplier_address_id) > 10)) {
            throw new \InvalidArgumentException('invalid length for $supplier_address_id when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurchaseOrderType., must be smaller than or equal to 10.');
        }
    ...
    public function setSupplierRespSalesPersonName($supplier_resp_sales_person_name)
    {
        ...
        if ((mb_strlen($supplier_resp_sales_person_name) > 30)) {
            throw new \InvalidArgumentException('invalid length for $supplier_resp_sales_person_name when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurchaseOrderType., must be smaller than or equal to 30.');
        }
    ...
    public function setSupplierPhoneNumber($supplier_phone_number)
    {
        ...
        if ((mb_strlen($supplier_phone_number) > 16)) {
            throw new \InvalidArgumentException('invalid length for $supplier_phone_number when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurchaseOrderType., must be smaller than or equal to 16.');
        }
    ...
    public function setSupplyingSupplier($supplying_supplier)
    {
        ...
        if ((mb_strlen($supplying_supplier) > 10)) {
            throw new \InvalidArgumentException('invalid length for $supplying_supplier when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurchaseOrderType., must be smaller than or equal to 10.');
        }
    ...
    public function setSupplyingPlant($supplying_plant)
    {
        ...
        if ((mb_strlen($supplying_plant) > 4)) {
            throw new \InvalidArgumentException('invalid length for $supplying_plant when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurchaseOrderType., must be smaller than or equal to 4.');
        }
    ...
    public function setInvoicingParty($invoicing_party)
    {
        ...
        if ((mb_strlen($invoicing_party) > 10)) {
            throw new \InvalidArgumentException('invalid length for $invoicing_party when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurchaseOrderType., must be smaller than or equal to 10.');
        }
    ...
    public function setCustomer($customer)
    {
        ...
        if ((mb_strlen($customer) > 10)) {
            throw new \InvalidArgumentException('invalid length for $customer when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurchaseOrderType., must be smaller than or equal to 10.');
        }
    ...
    public function setPurchaseContract($purchase_contract)
    {
        ...
        if ((mb_strlen($purchase_contract) > 10)) {
            throw new \InvalidArgumentException('invalid length for $purchase_contract when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurchaseOrderType., must be smaller than or equal to 10.');
        }
    ...
    public function setSupplierQuotationExternalId($supplier_quotation_external_id)
    {
        ...
        if ((mb_strlen($supplier_quotation_external_id) > 10)) {
            throw new \InvalidArgumentException('invalid length for $supplier_quotation_external_id when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurchaseOrderType., must be smaller than or equal to 10.');
        }
    ...
    public function setItemNumberIntervalForSubItems($item_number_interval_for_sub_items)
    {
        ...
        if ((mb_strlen($item_number_interval_for_sub_items) > 5)) {
            throw new \InvalidArgumentException('invalid length for $item_number_interval_for_sub_items when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurchaseOrderType., must be smaller than or equal to 5.');
        }
    ...
    public function setPaymentTerms($payment_terms)
    {
        ...
        if ((mb_strlen($payment_terms) > 4)) {
            throw new \InvalidArgumentException('invalid length for $payment_terms when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurchaseOrderType., must be smaller than or equal to 4.');
        }
    ...
    public function setDownPaymentType($down_payment_type)
    {
        ...
        if ((mb_strlen($down_payment_type) > 4)) {
            throw new \InvalidArgumentException('invalid length for $down_payment_type when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurchaseOrderType., must be smaller than or equal to 4.');
        }
    ...
    public function setIncotermsClassification($incoterms_classification)
    {
        ...
        if ((mb_strlen($incoterms_classification) > 3)) {
            throw new \InvalidArgumentException('invalid length for $incoterms_classification when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurchaseOrderType., must be smaller than or equal to 3.');
        }
    ...
    public function setIncotermsTransferLocation($incoterms_transfer_location)
    {
        ...
        if ((mb_strlen($incoterms_transfer_location) > 28)) {
            throw new \InvalidArgumentException('invalid length for $incoterms_transfer_location when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurchaseOrderType., must be smaller than or equal to 28.');
        }
    ...
    public function setIncotermsVersion($incoterms_version)
    {
        ...
        if ((mb_strlen($incoterms_version) > 4)) {
            throw new \InvalidArgumentException('invalid length for $incoterms_version when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurchaseOrderType., must be smaller than or equal to 4.');
        }
    ...
    public function setIncotermsLocation1($incoterms_location1)
    {
        ...
        if ((mb_strlen($incoterms_location1) > 70)) {
            throw new \InvalidArgumentException('invalid length for $incoterms_location1 when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurchaseOrderType., must be smaller than or equal to 70.');
        }
    ...
    public function setIncotermsLocation2($incoterms_location2)
    {
        ...
        if ((mb_strlen($incoterms_location2) > 70)) {
            throw new \InvalidArgumentException('invalid length for $incoterms_location2 when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurchaseOrderType., must be smaller than or equal to 70.');
        }
    ...
    public function setCorrespncExternalReference($correspnc_external_reference)
    {
        ...
        if ((mb_strlen($correspnc_external_reference) > 12)) {
            throw new \InvalidArgumentException('invalid length for $correspnc_external_reference when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurchaseOrderType., must be smaller than or equal to 12.');
        }
    ...
    public function setCorrespncInternalReference($correspnc_internal_reference)
    {
        ...
        if ((mb_strlen($correspnc_internal_reference) > 12)) {
            throw new \InvalidArgumentException('invalid length for $correspnc_internal_reference when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurchaseOrderType., must be smaller than or equal to 12.');
        }
    ...
    public function setPricingDocument($pricing_document)
    {
        ...
        if ((mb_strlen($pricing_document) > 10)) {
            throw new \InvalidArgumentException('invalid length for $pricing_document when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurchaseOrderType., must be smaller than or equal to 10.');
        }
    ...
    public function setPricingProcedure($pricing_procedure)
    {
        ...
        if ((mb_strlen($pricing_procedure) > 6)) {
            throw new \InvalidArgumentException('invalid length for $pricing_procedure when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurchaseOrderType., must be smaller than or equal to 6.');
        }
    ...
    public function setDocumentCurrency($document_currency)
    {
        ...
        if ((mb_strlen($document_currency) > 3)) {
            throw new \InvalidArgumentException('invalid length for $document_currency when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurchaseOrderType., must be smaller than or equal to 3.');
        }
    ...
    public function setTaxReturnCountry($tax_return_country)
    {
        ...
        if ((mb_strlen($tax_return_country) > 3)) {
            throw new \InvalidArgumentException('invalid length for $tax_return_country when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurchaseOrderType., must be smaller than or equal to 3.');
        }
    ...
    public function setVatRegistrationCountry($vat_registration_country)
    {
        ...
        if ((mb_strlen($vat_registration_country) > 3)) {
            throw new \InvalidArgumentException('invalid length for $vat_registration_country when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurchaseOrderType., must be smaller than or equal to 3.');
        }
    ...
    /**
     * Gets purg_aggrgd_prod_cmplnc_suplr_sts
     *
     * @return string|null
     */
    public function getPurgAggrgdProdCmplncSuplrSts()
    {
        return $this->container['purg_aggrgd_prod_cmplnc_suplr_sts'];
    }

    /**
     * Sets purg_aggrgd_prod_cmplnc_suplr_sts
     *
     * @param string|null $purg_aggrgd_prod_cmplnc_suplr_sts Product Compliance Supplier Check Status (All Items)
     *
     * @return self
     */
    public function setPurgAggrgdProdCmplncSuplrSts($purg_aggrgd_prod_cmplnc_suplr_sts)
    {
        if (is_null($purg_aggrgd_prod_cmplnc_suplr_sts)) {
            throw new \InvalidArgumentException('non-nullable purg_aggrgd_prod_cmplnc_suplr_sts cannot be null');
        }
        if ((mb_strlen($purg_aggrgd_prod_cmplnc_suplr_sts) > 1)) {
            throw new \InvalidArgumentException('invalid length for $purg_aggrgd_prod_cmplnc_suplr_sts when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurchaseOrderType., must be smaller than or equal to 1.');
        }

        $this->container['purg_aggrgd_prod_cmplnc_suplr_sts'] = $purg_aggrgd_prod_cmplnc_suplr_sts;

        return $this;
    }

    /**
     * Gets purg_aggrgd_prod_marketability_sts
     *
     * @return string|null
     */
    public function getPurgAggrgdProdMarketabilitySts()
    {
        return $this->container['purg_aggrgd_prod_marketability_sts'];
    }

    /**
     * Sets purg_aggrgd_prod_marketability_sts
     *
     * @param string|null $purg_aggrgd_prod_marketability_sts Product Marketability Status (All Items)
     *
     * @return self
     */
    public function setPurgAggrgdProdMarketabilitySts($purg_aggrgd_prod_marketability_sts)
    {
        if (is_null($purg_aggrgd_prod_marketability_sts)) {
            throw new \InvalidArgumentException('non-nullable purg_aggrgd_prod_marketability_sts cannot be null');
        }
        if ((mb_strlen($purg_aggrgd_prod_marketability_sts) > 1)) {
            throw new \InvalidArgumentException('invalid length for $purg_aggrgd_prod_marketability_sts when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurchaseOrderType., must be smaller than or equal to 1.');
        }

        $this->container['purg_aggrgd_prod_marketability_sts'] = $purg_aggrgd_prod_marketability_sts;

        return $this;
    }

    /**
     * Gets purg_aggrgd_sfty_data_sheet_status
     *
     * @return string|null
     */
    public function getPurgAggrgdSftyDataSheetStatus()
    {
        return $this->container['purg_aggrgd_sfty_data_sheet_status'];
    }

    /**
     * Sets purg_aggrgd_sfty_data_sheet_status
     *
     * @param string|null $purg_aggrgd_sfty_data_sheet_status Safety Data Sheet Status (All Items)
     *
     * @return self
     */
    public function setPurgAggrgdSftyDataSheetStatus($purg_aggrgd_sfty_data_sheet_status)
    {
        if (is_null($purg_aggrgd_sfty_data_sheet_status)) {
            throw new \InvalidArgumentException('non-nullable purg_aggrgd_sfty_data_sheet_status cannot be null');
        }
        if ((mb_strlen($purg_aggrgd_sfty_data_sheet_status) > 1)) {
            throw new \InvalidArgumentException('invalid length for $purg_aggrgd_sfty_data_sheet_status when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurchaseOrderType., must be smaller than or equal to 1.');
        }

        $this->container['purg_aggrgd_sfty_data_sheet_status'] = $purg_aggrgd_sfty_data_sheet_status;

        return $this;
    }

    /**
     * Gets purg_prod_cmplnc_tot_dngrs_goods_sts
     *
     * @return string|null
     */
    public function getPurgProdCmplncTotDngrsGoodsSts()
    {
        return $this->container['purg_prod_cmplnc_tot_dngrs_goods_sts'];
    }

    /**
     * Sets purg_prod_cmplnc_tot_dngrs_goods_sts
     *
     * @param string|null $purg_prod_cmplnc_tot_dngrs_goods_sts Dangerous Goods Status (All Items)
     *
     * @return self
     */
    public function setPurgProdCmplncTotDngrsGoodsSts($purg_prod_cmplnc_tot_dngrs_goods_sts)
    {
        if (is_null($purg_prod_cmplnc_tot_dngrs_goods_sts)) {
            throw new \InvalidArgumentException('non-nullable purg_prod_cmplnc_tot_dngrs_goods_sts cannot be null');
        }
        if ((mb_strlen($purg_prod_cmplnc_tot_dngrs_goods_sts) > 1)) {
            throw new \InvalidArgumentException('invalid length for $purg_prod_cmplnc_tot_dngrs_goods_sts when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurchaseOrderType., must be smaller than or equal to 1.');
        }

        $this->container['purg_prod_cmplnc_tot_dngrs_goods_sts'] = $purg_prod_cmplnc_tot_dngrs_goods_sts;
    ...
    public function setPurchasingCollectiveNumber($purchasing_collective_number)
    {
        ...
        if ((mb_strlen($purchasing_collective_number) > 10)) {
            throw new \InvalidArgumentException('invalid length for $purchasing_collective_number when calling ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurchaseOrderType., must be smaller than or equal to 10.');
        }
     ...
     *
     * @param \BeLenka\SAP\PurchaseOrder\Model\ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurchaseOrderNoteType[]|null $_purchase_order_note _purchase_order_note
     *
     * @return self
     */
     ...
     *
     * @param \BeLenka\SAP\PurchaseOrder\Model\ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurchaseOrderPartnerType[]|null $_purchase_order_partner _purchase_order_partner
     *
     * @return self
     */
     ...
     *
     * @param \BeLenka\SAP\PurchaseOrder\Model\ComSapGatewaySrvdA2xApiPurchaseorder2V0001PurchaseOrderSupplierAddressType|null $_supplier_address _supplier_address
     *
     * @return self
     */
